...
namespace AppIndicator {
	[CCode (cheader_filename = "libappindicator/app-indicator.h", type_check_function = "IS_APP_INDICATOR")]
	public class Indicator : GLib.Object {
		...
		public virtual signal void act ();
	...
	[CCode (cheader_filename = "libappindicator/app-indicator.h", cprefix = "APP_INDICATOR_CATEGORY_")]
	...
	[CCode (cheader_filename = "libappindicator/app-indicator.h", cprefix = "APP_INDICATOR_STATUS_")]
	public enum IndicatorStatus {
		PASSIVE,
		ACTIVE,
		ATTENTION
	}
	[CCode (cheader_filename = "libappindicator/app-indicator.h", cname = "APP_INDICATOR_SIGNAL_ACT")]
	public const string INDICATOR_SIGNAL_ACT;
